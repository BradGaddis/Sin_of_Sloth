...
<tileset version="1.9" tiledversion="1.9.0" name="placeholder tilset" tilewidth="32" tileheight="32" tilecount="16" columns="4">
 <image source="../../assets/placeholder tileset.png" width="128" height="128"/>
 <wangsets>
  <wangset name="placeholder edge" type="edge" tile="-1">
   <wangcolor name="base" color="#ff0000" tile="-1" probability="1"/>
